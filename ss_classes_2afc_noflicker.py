...
class Params(object):
    ...
    """
    def __init__(self, p_file='ss_params_2afc_noflicker'):
        """
        ...
        p_file: string, the name of a parameter file, defaults to 'ss_params_2afc_noflicker'
...
def make_trial_list(win,params):
    ...
    #If the input is not valid throw and error:
            ...
            raise ValueError("Need to set params.paradigm to a valid value (in ss_params_2afc_noflicker.py")
